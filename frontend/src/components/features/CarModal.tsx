        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
          ...
          <div className="pt-6 border-t border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <button 
              ...
              className="w-full sm:w-auto bg-green-600 hover:bg-green-500 text-white font-bold py-3 px-8 rounded-lg transition-all shadow-lg hover:shadow-green-500/20"
            >
